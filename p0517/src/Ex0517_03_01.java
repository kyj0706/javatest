...
public class Ex0517_03_01 {
	...
	public static void main(String[] args) {
		...
		String[] boardTitle = { "새글이 등록되었습니다.", "홈페이지 오픈", "내일수업 하나요?", "한국직업전문학교 소개", "우리반은 몇명의 학생이 있나요?",
				"언재까지 수업을 하나요?", "한국직업전문학교 위치가 어떻게 되나요?", "사이트 만드는 방법", "한국직업전문학교 사이트가 있나요?" };
